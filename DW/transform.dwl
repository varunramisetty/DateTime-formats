...
var myDate = now()
//im assuming the variable myData with now()
---
[{
...
//in this particular object im using the variable myDate to get the values
{
...
//in this object by using myDate varibale to do addtions and subtractions
{
